...
public class RegistroAlumnos extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                txt_grupo.setText(rs.getString("Seccion"));
            } else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
           ...
           Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/bd_registro", "root", "");
           PreparedStatement pst = cn.prepareStatement("update estudiantes set NombreEstudiante = ?, Seccion = ? where ID = " + ID);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
           ...
           PdfWriter.getInstance(documento, new FileOutputStream(ruta +"/Escritorio/Reporte Estudiantes.pdf"));
           documento.open();
           
           PdfPTable tabla = new PdfPTable(3);
           tabla.addCell("Codigo");
           tabla.addCell("Nombre del Estudiante");
           tabla.addCell("Grupo");
